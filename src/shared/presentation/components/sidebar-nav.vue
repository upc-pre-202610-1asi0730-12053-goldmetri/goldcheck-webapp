...
const navItems = computed(() => {
  if (segment.value === 'mining') {
    return [
      ...
      { name: 'fleet-custody',         label: t('nav.custody'),         icon: 'pi pi-id-card',              to: '/app/fleet/custody' },
      { name: 'fleet-start-route',     label: t('nav.startRoute'),      icon: 'pi pi-play',                 to: '/app/fleet/start-route' },
      { name: 'material-dashboard',    label: t('nav.materialOps'),     icon: 'pi pi-server',               to: '/app/material/dashboard' },
      { name: 'material-typing',       label: t('nav.mineralTyping'),   icon: 'pi pi-tags',                 to: '/app/material/typing' },
      { name: 'material-shrinkage',    label: t('nav.shrinkage'),       icon: 'pi pi-percentage',           to: '/app/material/shrinkage' },
